        ...
        <header className={styles.header}>
            ...
            {search ?
                <div className={`${styles.searchBar} bg-light-night-blue`}>
                    ...
                    <input type="text" value={searchQuery} onChange={onSearchChange} id="search" name="search" className="clr-white fs-400 fw-600 bg-light-night-blue" placeholder="Cerca un anime" />
                </div> :
